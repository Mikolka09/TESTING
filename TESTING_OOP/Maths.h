...
public:
	...
	void menu_maths_user(const list<Results*>& res);     //меню по математике для пользователя
...
public:
	...
	void menu_alg(const list<Results*>& res);               //меню по алгебре для пользователя
	void passing_test_alg(const list<Results*>& res);       //прохождение теста по алгебре
...
public:
	...
	void menu_geo(const list<Results*>& res);   //меню по геометрии для пользователя
	void passing_test_geo(const list<Results*>& res);       //прохождение теста по геометрии
